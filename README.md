...
I haven't included any additional validation. also in order to validate  "the productType attribute has value PERSONAL_LOAN" - i haven't parsed each json value in the response payload individually. API response is big so I skipped POJO and parsing process. 
